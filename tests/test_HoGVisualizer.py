...
def test_hog_visualizer_color(
    hog_visualizer: imvf.HoGVisualizer, color_image: NDArray[np.uint8]
) -> None:
...
def test_hog_visualizer_gray(
    hog_visualizer: imvf.HoGVisualizer, gray_image: NDArray[np.uint8]
) -> None:
...
def test_hog_visualizer_str(
    hog_visualizer: imvf.HoGVisualizer,
) -> None:
